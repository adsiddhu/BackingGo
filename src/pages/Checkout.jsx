...
const Checkout = () => {
  const { cartItems, cartTotal, deliveryCharge, clearCart } = useCart();
            ...
            <form onSubmit={handleSubmit} className="bg-white p-6 md:p-8 rounded-2xl shadow-sm border border-gray-100 space-y-6">
              ...
              <div className="pt-6">
                <button
                  ...
                  className="btn-primary w-full py-3 text-lg flex items-center justify-center gap-2 disabled:opacity-70 disabled:cursor-not-allowed"
                >
                  {isSubmitting ? (
                    <ButtonLoading />
                  ) : (
